...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2021 at 09:46 AM
...
CREATE TABLE IF NOT EXISTS `po_head_revised` (
  ...
  `vat` decimal(10,2) NOT NULL DEFAULT '0.00',
  `vat_percent` int(11) NOT NULL DEFAULT '0',
  `vat_in_ex` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
`proj_act_id` int(11) NOT NULL,
  ...
  `est_total_materials` decimal(10,2) NOT NULL,
  `total_weekly_schedule` decimal(10,2) NOT NULL,
...
`pr_details_id` int(11) NOT NULL,
  ...
  `recom_unit_price` decimal(10,2) NOT NULL DEFAULT '0.00',
  `recom_qty` decimal(10,2) NOT NULL DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(220, 'Prism Import-Export, Inc.', 'Roofing Materials, Lubricants', 0, 'C.L. Montelibano Avenue, Bacolod City', '(034) 433-6045/708-4443/433-5327', '', '434-6433', '', '30 days PDC', 'Manufacturer / Wholesaler / Retail', 'Mr. Jun Bacong ', '', 'Active', '1.00', 1, ''),
...
(606, 'Macjils Refrigeration and Air Conditioning Repair Shop', 'Air Conditioning Unit (ACU) Brand New Units, Repair, Maintenance', 0, 'Prk. Sto. Rosario, lacson St., Bacolod City', '(034) 707-0639 / 0919-637-0637', NULL, '', NULL, 'COD', 'Supplier / Contractor', 'Mr. Mamerto Yalong - mamertoyalong@gmail.com', '', 'Active', '2.00', 1, ''),
...
--
ALTER TABLE `employees`
MODIFY `employee_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=138;
--
...
--
ALTER TABLE `vendor_head`
MODIFY `vendor_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=621;
