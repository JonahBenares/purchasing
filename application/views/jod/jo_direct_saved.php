						  		...
						  		<span style="margin-left:10px"><small>Choose RFD:</small></span>
							   	<ul style="margin:0px;">
							    	<?php foreach($rfd AS $r){ ?>
										<li style="text-align: left!important"><a href="<?php echo base_url(); ?>jod/jod_rfd_saved/<?php echo $r->joi_id; ?>/<?php echo $r->joi_rfd_id; ?>" target='_blank' class="btn btn-link"><?php echo "APV# ".$r->apv_no; ?></a></li>
									<?php } ?>
							    </ul>
						  	</div>
						<?php } } ?>
