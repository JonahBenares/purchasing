 <script src="<?php echo base_url(); ?>assets/js/jo.js"></script>
    ...
    <div  class="pad">
    	...
    	<form method='POST' action='<?php echo base_url(); ?>jod/save_jod_rfd'>  
    		<div  id="prnt_btn">
	    		<center>
			    	<div class="btn-group">
	    	...
	    	<div style="background: #fff;" class=""> <!-- <?php  if($cancelled==1){ echo 'cancel'; }?> add class cancel -->
		    	<table class="table-borsdered" width="100%" style="border:1px solid #000">
		    		...
		    		<tr>
		    			...
		    			<td align="right" colspan="3">
		    				<span class="pull-left nomarg">₱</span>
		    				<b style="font-weight: 900"><span class="nomarg" id=''><?php echo number_format($totalamt,2); ?></span></b>
		    			</td>
		    		</tr>
		    		<?php 
		    			...
		    			<td align="right" colspan="3">
		    				<span class="nomarg" id=''>
								<b style="font-weight: 900">
									<input type="text" style="text-align: right;" onkeypress="return isNumberKey(this, event)" class="payment_amount" onblur="check_rfd()" onchange='changePrice_rfd();' name="payment_amount[]" id="payment_amount" placeholder="Amount">
