    	...
    	<form method='POST' action='<?php echo base_url(); ?>jod/save_change_order'>  
    		<div  id="prnt_btn">
	    		<center>
			    	<div class="abtn-group">
						<a href='<?php echo base_url(); ?>jor/jor_list' class="btn btn-success btn-md p-l-50 p-r-50"><span class="fa fa-arrow-left"></span> Back</a>
						...
						<?php } else { ?>
							 <a class="btn btn-custon-three btn-info btn-md approverev" title='Approve Revision' data-toggle="modal" data-target="#approve" data-id="<?php echo $joi_id; ?>"><span class="fa fa-thumbs-up"></span> Approve Revision</a>
						<?php } ?>
					</div>
	    	...
	    	<div style="background: #fff;" >  
		    	...
		    	<table class="table-borsdered" width="100%" style="border:2px solid #000">
		    		...
		    		<tr><td colspan="20" align="center"><h4 class="m-b-0"><b>JOB ORDER</b></h4><small class="text-red">CHANGE ORDER FORM</small></td></tr>
		    					...
		    					<table width="100%">
						    		...
						    		if($revised==0){
							    		if(!empty($items)){
								    		...
								    		<tr>
								    			<td colspan="" class="bor-right v-align" align="center"><b><?php echo $x; ?></b></td>
								    			<td colspan="2" class="bor-right v-align" align="center"><input type='number' name='quantity<?php echo $x; ?>' id='quantity<?php echo $x; ?>' class='quantity' value='<?php echo $it->delivered_quantity; ?>' style='width:100%; color:red' onkeyup='changePrice(<?php echo $x; ?>)' onkeypress="return isNumberKey(this, event)"></td>
								    			<!-- <td colspan="" class="bor-right v-align" align="center"><b><?php echo $it->uom; ?></b></td> -->
    	...
    	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form method="POST" action="<?php echo base_url(); ?>jo/add_tc_temp">
						<div class="modal-body">
							<div class="form-group">
								Terms & Conditions:
		...
		<div class="modal fade" id="otherins" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form method="POST" action="<?php echo base_url(); ?>jo/add_otherins_temp">
						<div class="modal-body">
							<div class="form-group">
								Other Instructions:
