		    		...
		    		<tr>
		    			<td colspan="20">
		    				<table class="table-bordsered" width="100%">
		    					...
		    					<tr>
		    						<td class="f13 p-l-5" align="left">
		    							<b class="nomarg"><textarea rows="4" style="width:100%" name='materials_offer'><?php echo $it->materials_offer; ?></textarea></b>
		    						</td>
		    						<td class="f13" align="center" style="vertical-align:top">
		    							<b>	
		    								<input type="text" name='materials_qty' id='materials_qty' class='materials_qty' value="<?php echo $it->materials_qty; ?>" style='width:50px; color:red;text-align: center' onchange='changesinglePrice_JO()' onkeypress="return isNumberKey(this, event)"/>
		    							</b>
		    						</td>
		    						<td class="f13" align="center" style="vertical-align:top"><b><input type='text' style='color:red; width:50px;text-align: center' name='materials_uom' value="<?php echo $it->materials_unit; ?>"></b></td>
		    						<td class="f13" align="center" style="vertical-align:top">
				    				<select name='materials_currency' style="width: 100%;">
						    			<?php foreach($currency2 AS $curr){ ?>
		    					...
		    					<tr>
		    						...
		    						<td class="bor-btm" align="right"><span class="pull-left"><?php echo $currency; ?></span><input class="nobord" type="text" name="less_amount" id='less_amount' value="<?php echo number_format($discount,2); ?>" onblur='changePrice()' style="width: 100%;text-align: right;"></td>
		    					</tr>
		    					<tr>
		    						<td></td>
		    						<td></td>
