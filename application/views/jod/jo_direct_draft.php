    ...
    <div  class="pad">
    	<form method='POST' action='<?php echo base_url(); ?>jod/save_jo_draft'>  
    		<div  id="prnt_btn">
	    		<center>
			    	<div class="abtn-group">
						<a href="javascript:history.go(-1)" class="btn btn-success btn-md p-l-100 p-r-100"><span class="fa fa-arrow-left"></span> Back</a>
						<a href = '<?php echo base_url(); ?>jod/jo_direct_saved/<?php echo $joi_id; ?>' class="btn btn-warning btn-md p-l-50 p-r-50"><span class="fa fa-print"></span> Print</a>
	    	...
	    	<div style="background: #fff;">   
		    	...
		    	<table class="table-borsdered" width="100%" style="border:2px solid #000;border-bottom: none;">
		    		...
		    		<tr>
		    			...
		    			<td colspan="5"><h6 class="nomarg"><b>P.O. No.: <?php echo $h['joi_no'] ."-".COMPANY. (($revision_no!=0) ? ".r".$revision_no : "");  ?></b></h6></td>
		    		</tr>	
		    		<tr>
		    		...
		    		<tr>
		    			...
		    			<td colspan="12" class="bor-right v-align" align="left"><b class="nomarg"><textarea class = "form-control" name='scope_of_work<?php echo $x; ?>'><?php echo $it['scope_of_work']; ?></textarea></b></td>
				...
				<div class="modal-content">
					...
					<form method="POST" action="<?php echo base_url(); ?>jod/update_notes">
						...
						<div class="modal-footer">
							...
							<input type='hidden' name='jor_id' value='<?php echo $jor_id; ?>'>
							<input type='hidden' name='group_id' value='<?php echo $group_id; ?>'>
							<input type='hidden' name='joi_tc_id' id = "joi_tc1_id">
							<input type="submit" class="btn btn-primary btn-block" value="Save changes">
						</div>
					</form>
				</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form method="POST" action="<?php echo base_url(); ?>jod/update_condition_draft">
						...
						<input type='hidden' name='jor_id' value='<?php echo $jor_id; ?>'>
						<input type='hidden' name='group_id' value='<?php echo $group_id; ?>'>
						<input type='hidden' name='joi_tc_id' id = "joi_tc_id">
						<div class="modal-footer">
							<input type="submit" class="btn btn-primary btn-block" value="Save changes">
						</div>
