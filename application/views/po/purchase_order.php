	    	...
	    	<div style="background: #fff;">    	
		    	...
		    	<table class="table-borsdered" width="100%" style="border:2px solid #000">
		    		...
		    		<tr>
		    			...
		    			<td colspan="" class="bor-right v-align" align="center"><b><input type='text' name='quantity<?php echo $x; ?>' id='quantity<?php echo $x; ?>' class='quantity' value='<?php echo number_format($it['balance'],2); ?>' min='0' <?php echo (($revised!='r') ? "max='".$it['balance'] : "")."'"; ?> style='width:50px; color:red' onkeyup='changePrice(<?php echo $x; ?>)' onkeypress="return isNumberKey(this, event)"></b></td>
		    		...
		    		<input type='hidden' name='balance<?php echo $x; ?>' id='balance<?php echo $x; ?>' value="<?php echo number_format($it['balance'],2); ?>">
			    		<?php 
			    		$x++; 
		    				} 
		    			}
