  	...
  	<style type="text/css">
		...
		@media print{
			...
			.btn_prnt_hide,.prnt,#prnt_btn,#item-btn,#pr-btn,#updateTermRep{
				display: none;
			}
			.emphasis{
		    				...
		    				<table  class="table-borddered" width="100%" style="border:1px solid #000;">
					    		...
					    		<tr>
					    			...
					    			<td colspan="" class="bor-right" align="center">
					    				...
					    				<b><input type='number' name='quantity<?php echo $x; ?>' id='quantity<?php echo $x; ?>' class='quantity' step="any" min='0' max='<?php echo $it['quantity']; ?>' value='<?php echo $it['quantity']; ?>' style='width:50px; color:red' onkeyup='changePrice(<?php echo $x; ?>)' onchange='changePrice(<?php echo $x; ?>)' onkeypress="return isNumberKey(this, event)"></b>
					    			</td>
		    				...
		    				<?php foreach($tc AS $t){ ?>
								<p style = "color:blue;"><?php echo nl2br($t->notes);?> 
									<?php if(!empty($t->notes)){ ?>
										<a class='btn btn-primary btn-xs btn_prnt_hide' id = "edits" data-toggle='modal' data-target='#EditIns' data-id = '<?php echo $t->po_tc_id; ?>' data-name = '<?php echo $t->notes; ?>'>
					    					<span class = 'fa fa-edit'></span>
					    				</a>
					    				<a href="<?php echo base_url(); ?>index.php/po/delete_repeatorder_inst/<?php echo $t->po_tc_id;?>/<?php echo $t->po_id;?>/<?php echo $pr_id;?>/<?php echo $group_id;?>" class="btn btn-custon-three btn-danger btn-xs btn_prnt_hide" onclick="confirmationDelete(this);return false;">
	...
	<div class="modal fade" id="otherins" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form method="POST" action="<?php echo base_url(); ?>po/add_repeatorder_notes">
					<div class="modal-body">
						<div class="form-group">
							Other Instructions:
	...
	<div class="modal fade" id="EditIns" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form method="POST" action="<?php echo base_url(); ?>po/update_repeatorder_notes">
					<div class="modal-body">
						<div class="form-group">
							Other Instructions:
