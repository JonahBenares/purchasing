		    					...
		    					<table width="100%">
						    		...
						    		if($revised==0){
							    		if(!empty($items)){
								    		...
								    		<tr>
								    			<td colspan="" class="bor-right v-align" align="center"><b><?php echo $x; ?></b></td>
												<td colspan="2" class="bor-right v-align" align="center"><input type='number' name='quantity<?php echo $x; ?>' id='quantity<?php echo $x; ?>' class='quantity' value='<?php echo number_format($it->delivered_quantity,2); ?>' step="any" min='0' max='<?php echo $balance; ?>' style='width:100%; color:red' onkeyup='changePrice(<?php echo $x; ?>)' onchange='changePrice(<?php echo $x; ?>)' onkeypress="return isNumberKey(this, event)"></td>
