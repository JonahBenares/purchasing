    		...
    		<div  id="prnt_btn">
	    		<center>
			    	<div class="abtn-group">
						...
						<?php if($revised==0){ ?>
						<a  href='<?php echo base_url(); ?>po/purchase_order_rev' onclick="return confirm('Are you sure you want to revise PO?')" class="btn btn-info btn-md p-l-25 p-r-25"><span class="fa fa-pencil"></span> Revise <u><b>PO</b></u></a>
						<?php } ?>
