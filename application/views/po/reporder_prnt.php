		    				...
		    				<?php foreach($tc AS $t){ ?>
								<p style = "color:blue;"><?php echo nl2br($t->notes);?> 
									<?php if(!empty($t->notes)){ ?>
					    				...
					    				<a href="<?php echo base_url(); ?>index.php/po/delete_repeatorder_inst/<?php echo $t->po_tc_id;?>/<?php echo $t->po_id;?>/<?php echo $pr_id;?>/<?php echo $group_id;?>" class="btn btn-custon-three btn-danger btn-xs prnt" onclick="confirmationDelete(this);return false;">
