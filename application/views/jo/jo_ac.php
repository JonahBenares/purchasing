    	...
    	<form method='POST' action=''>  
    		<div  id="prnt_btn">
	    		<center>
					...
					<p class="text-white">Instructions: When printing ACKNOWLEDGMENT RECEIPT make sure the following options are set correctly -- <u>Browser</u>: Chrome, <u>Layout</u>: Portrait, <u>Paper Size</u>: A4 <u>Margin</u> : Default <u>Scale</u>: 100 and the option: Background graphics is checked</p>
				</center>
			</div>
	    	<div style="background: #fff;" class=""> <!-- add class cancel -->
		    	<table class="table-bordsered" width="100%" style="border:1px solid #000">
		    		...
		    		<tr><td colspan="20" align="center"><h5><b class="">ACKNOWLEDGMENT RECEIPT</b></h5></td></tr>

		    		<tr>
		    			<td colspan="3" class="all-border "><b class="nomarg">DR No. </b></td>
		    			<td colspan="17" class="all-border "><h4 style="margin:0px"><b>DR 2019-018</b></h4> </td>
		    		</tr>		    		
		    		<tr>
		    		...
		    		<tr>
		    			...
		    			<td colspan="17" class="all-border"><b class="nomarg">CENJO</b></td>
		    		</tr>
		    		<tr>
		    		...
		    		<tr>
		    			<td colspan="2"></td>
		    			<td colspan="4" align="center">Imelda P. Esmeralda</td>
		    			<td colspan="2"></td>
		    			<td colspan="4" align="center">Print Name & Signature with Date Received</td>
		    			<td colspan="2"></td>
		    			<td colspan="4" align="center">Alona Arroyo</td>
		    			<td colspan="2"></td>
		    		</tr>
		    		<tr><td class="f13" colspan="20" align="center"><br></td></tr>
		    		<tr><td class="f13" colspan="20" align="center"><br></td></tr>
