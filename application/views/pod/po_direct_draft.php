	    	...
	    	<div style="background: #fff;">   
		    	...
		    	<table class="table-borsdered" width="100%" style="border:2px solid #000;border-bottom: none;">
		    		...
		    		<tr>
						...
						<td colspan="" class="bor-right v-align" align="center"><b><input type='number' name='quantity<?php echo $x; ?>' id='quantity<?php echo $x; ?>' class='quantity' value='<?php echo number_format($it['quantity'],2); ?>' step="any" min='0' max='<?php echo $it['quantity']; ?>' style='width:50px; color:red' onkeyup='changePrice(<?php echo $x; ?>)' onchange='changePrice(<?php echo $x; ?>)' onkeypress="return isNumberKey(this, event)"></b></td>
		    			...
		    			<td colspan="2" class="bor-right v-align" align="center"><b><input type='text' name='price<?php echo $x; ?>' id='price<?php echo $x; ?>'  onkeyup='changePrice(<?php echo $x; ?>)' onkeypress="return isNumberKey(this, event)" style='color:red; width:100px' value='<?php echo number_format($it['price'],6); ?>'></b></td>
