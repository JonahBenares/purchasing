	    	...
	    	<div style="background: #fff;">   
		    	...
		    	<table class="table-borsdered" width="100%" style="border:2px solid #000;border-bottom: none;">
		    		...
		    		<tr>
		    			...
		    			<td colspan="2" class="bor-right v-align" align="center"><b><?php if($saved==0){ ?><input type='text' name='price<?php echo $x; ?>' id='price<?php echo $x; ?>'  onkeyup='changePrice(<?php echo $x; ?>)' onkeypress="return isNumberKey(this, event)" style='color:red; width:100px' ><?php }else { echo number_format($it['price'],6); } ?></b></td>
		    		...
		    		<tr>
	    				...
	    				<p class="nomarg">
	    					...
	    					PR No.: <?php echo $pp['pr_no']."-".COMPANY; ?><br>
