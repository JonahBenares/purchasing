...
<script src="<?php echo base_url(); ?>assets/js/po.js"></script> 
     ...
     <div class="modal fade" id="approve" tabindex="-1" role="dialog" aria-labelledby="approveLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method='POST' action="<?php echo base_url(); ?>pod/approve_revision">
    ...
    <div  class="pad">
    	<form method='POST' action='<?php echo base_url(); ?>pod/save_change_order'>  
    		<div  id="prnt_btn">
	    		<center>
			    	<div class="abtn-group">
						...
						<?php } else { ?>
							 <a class="btn btn-custon-three btn-info btn-md approverev" title='Approve Revision' data-toggle="modal" data-target="#approve" data-id="<?php echo $po_id; ?>"><span class="fa fa-thumbs-up"></span> Approve Revision</a>
						<?php } ?>
					</div>
		    				...
		    				<div class="newdata">
		    					<table width="100%">
		    						...
		    						<tr>
						    			...
						    			<td colspan="2" class="all-border yellow-back" align="center"><b>Currency</b></td>
						    		...
						    		if($revised==0){
							    		if(!empty($items)){
								    		...
								    		<tr>
								    			<td colspan="" class="bor-right v-align" align="center"><b><?php echo $x; ?></b></td>
												<td colspan="2" class="bor-right v-align" align="center"><input type='number' step='any' min='0' name='quantity<?php echo $x; ?>' id='quantity<?php echo $x; ?>' max="<?php echo $balance; ?>" class='quantity' value='<?php echo number_format($it->delivered_quantity,2); ?>' style='width:100%; color:red' onkeyup='changePrice(<?php echo $x; ?>)' onchange='changePrice(<?php echo $x; ?>)' onkeypress="return isNumberKey(this, event)"></td>
								    			...
								    			<td colspan="2" class="bor-right v-align" align="center"><input type='text' name='price<?php echo $x; ?>' id='price<?php echo $x; ?>' value='<?php echo number_format($it->unit_price,6); ?>' onkeyup='changePrice(<?php echo $x; ?>)' onkeypress="return isNumberKey(this, event)" style='color:red; width:100px' ></td>
							    		...
							    		if(!empty($items)){
								    		...
								    		<tr>
												...
												<td colspan="2" class="bor-right" align="center"><?php echo number_format($it->delivered_quantity,2); ?></td>
		    				...
		    				<?php  if($revised==0){ ?>
								...
								?>
									<p style = "color:blue;">
										<?php if(!empty($t->notes)){  ?>
											...
											<a href="<?php echo base_url(); ?>index.php/pod/delete_inst/<?php echo $t->po_tc_id;?>/<?php echo $t->po_id;?>/purchase_order_rev" class="btn btn-custon-three btn-danger btn-xs" id = "prnt_btn" onclick="confirmationDelete(this);return false;">
								...
								<?php 
									...
									foreach($tc_temp AS $tt){ 
										if(!empty($tt->notes)){ 
								?>
									<!-- <textarea type = "text" style='color:blue;width:92%' rows = '1' class="form-control" name = "notes<?php echo $xs; ?>"><?php echo $tt->notes; ?></textarea> -->
									<p style = "color:blue;">
										<?php echo nl2br($tt->notes); ?>
										<a class='btn btn-primary btn-xs prnt' id = "editstemp" data-toggle='modal' data-target='#EditInsTemp' data-id = '<?php echo $tt->po_tc_id; ?>' data-name = '<?php echo $tt->notes; ?>'>
											<span class = 'fa fa-edit'></span>
										</a>
										<a href="<?php echo base_url(); ?>index.php/pod/delete_inst_temp/<?php echo $tt->po_tc_id;?>/<?php echo $tt->po_id;?>/purchase_order_rev" class="btn btn-custon-three btn-danger btn-xs" id = "prnt_btn" onclick="confirmationDelete(this);return false;">
											<span class="fa fa-times"></span>
										</a>
									</p>
									<br>
		    		...
		    		<tr>
		    			<td colspan="20" style="padding: 10px!important">
			    			...
			    			?>
								...
								<!-- <input type = "text" style='color:red;width: 90%' name = "terms<?php echo $y; ?>" value = "<?php echo $t->tc_desc; ?>"> -->
							...
							<?php echo $x.". ".$tt->tc_desc; ?>
								...
								<a class='btn btn-primary btn-xs prnt' id = "updateTermTemp" data-toggle='modal' data-target='#UpdateTermsTemp' data-id = '<?php echo $tt->po_tc_id; ?>' data-name = '<?php echo $tt->tc_desc; ?>'>
									<span class = 'fa fa-edit'></span>
								</a>
								<br>
							<?php $x++; } $y++; } ?>
		...
		<div class="modal fade" id="EditInsTemp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form method="POST" action="<?php echo base_url(); ?>pod/update_notes_temp">
						<div class="modal-body">
							<div class="form-group">
								Other Instructions:
		...
		<div class="modal fade" id="UpdateTerms" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form method="POST" action="<?php echo base_url(); ?>pod/update_condition_revise">
						<div class="modal-body">
							<div class="form-group">
								Terms & Conditions:
		...
		<div class="modal fade" id="UpdateTermsTemp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form method="POST" action="<?php echo base_url(); ?>pod/update_condition_revise_temp">
						<div class="modal-body">
							<div class="form-group">
								Terms & Conditions:
