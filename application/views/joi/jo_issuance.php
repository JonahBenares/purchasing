		    			...
		    			<td colspan="20">
		    				<table class="table-borderesd" width="100%">
		    					...
		    					<tr>
		    						...
		    						<td class="f13" align="center" style="vertical-align:top">
		    							<b class="nomarg">
		    								<input type='text' name='materials_tprice<?php echo $y; ?>' id='materials_tprice<?php echo $y; ?>_<?php echo $b; ?>' class='materials_tprice' value="<?php echo $it['materials_amount']; ?>" style='width:110px;text-align: right' readonly>
		    							</b>
		    						</td>
		    					</tr>
