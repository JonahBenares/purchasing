                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <?php if($h['saved']==1){ ?>                                                 
                                                    <a href="" class="btn btn-custon-three btn-success btn-xs deliverpo" title='Deliver JO' onclick="deliver_jo('<?php echo base_url(); ?>','<?php echo $h['joi_id']?>','<?php echo $h['dr_id']?>')">
