...
/*
    ...
    public function approve_revision(){
      ...
      /*  foreach($this->super_model->custom_query("SELECT pr_details_id FROM po_items WHERE pr_details_id IN (SELECT pr_details_id FROM po_items_temp WHERE po_id='$po_id')") AS $omit){
