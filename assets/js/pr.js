function prAdditem(baseurl,id) {
    window.open(baseurl+"index.php/pr/pr_additem/"+id, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=50,left=280,width=800,height=500");
}
