...
function updateCompany(baseurl) {
    window.open(baseurl+"index.php/masterfile/update_company", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=50,left=450,width=500,height=500");
}
